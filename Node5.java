/******* DHIRAJ D GANDHI and PARISHILAN RAYAMAJHI ********/
...
public class Node5
{
	...
	public static int TO_PORT=7001;
	...
	public static Node_struct node=new Node_struct(5,map,MAX_CONNECTIONS);
	   
    Socket socket=null;
    static ServerSocket ss;
    
    Node5(Socket newSocket)
    {
    ...
    public static void main(String args[]) throws IOException, InterruptedException
    {
    	...
    	node.t[0] = new cl_thread(socket,Integer.toString(node.ID)+":2",node);
    	node.t[0].start();
